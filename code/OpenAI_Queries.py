    ...
    try:
        ...
        if llm_helper.vector_store_type != "AzureSearch":
            if llm_helper.vector_store.check_existing_index("embeddings-index"):
                ...
                If you prefer to use the old data structure, please change your Web App container image to point to the docker image: rag/oai-embeddings:2023-03-27_25. 
                """)
            else:
...
try:
    ...
    with col1:
        st.image(os.path.join('images','kom_logo.png'))
